...
export function PlayersTable({ data }) {
  ...
  const columns = React.useMemo(
    () => [
      ...
      {
        Header: "Player to Beat in Drills to Rank Up",
        showHeader: true,
        backgroundColor: "secondary",
        columns: [
          {
            accessor: "beatToReachRank2",
            Header: "R1 to R2",
            showHeader: true,
            showSortLabel: true,
            disableFilters: true
